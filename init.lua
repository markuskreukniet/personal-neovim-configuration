...
-- TODO: add: multiline comment, auto indent detection, minimap?, if vsplit, the margin window should be gone?

require("extra_windows")({
  RULER_COLUMN = RULER_COLUMN
})
