return function()
  ...
  local function set_indentation(expand_tab, space_indent_size)
    vim.opt.expandtab = expand_tab -- Converts tab characters into spaces when typing
    vim.opt.shiftwidth = space_indent_size -- Sets the number of spaces for indentation levels
    vim.opt.tabstop = space_indent_size -- Sets the number of spaces a tab character represents
  end
