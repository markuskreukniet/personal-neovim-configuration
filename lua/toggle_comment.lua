return function(config)
  ...
  local function get_positions()
    ...
    vim.api.nvim_feedkeys(vim.api.nvim_replace_termcodes("<Esc>", true, false, true), "x", false) -- TODO: efficient? + comment
  ...
  local function toggle_comments()
    ...
    -- TODO: efficient? + comment
    -- performance with bulk edits: Maybe also on other places
